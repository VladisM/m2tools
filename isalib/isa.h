...
#define PRIisa_iw "0x%08"PRIx32 /**< @brief Macro for printf to use with isa_instruction_word_t. */
#define SCNisa_iw "0x%08"SCNx32 /**< @brief Macro for scanf to use with isa_instruction_word_t. */
...
#define PRIisa_addr "0x%08"PRIx32 /**< @brief Macro for printf to use with isa_address_t. */
#define SCNisa_addr "0x%08"SCNx32 /**< @brief Macro for scanf to use with isa_address_t. */
